...
class DataManager():
    ...
    def save_data(self ,data):
        ...
        sql = 'insert into new_selected_actiontrailersspotlight ' \
              '(Trailer_title, Trailer_title_link, Trailer_comments, Trailer_comments_time,\
                  ...
                  Transfered_time_difference, Trailer_comments_sentiment, Trailer_comments_subjectivity, Trailer_comments_preference)' \
