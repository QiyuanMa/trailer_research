import json
import re
from title_match_749.datamanage_movietrailersource import DataManager

db = DataManager()


def load_trailer():
    with open(r'C:\Users\student\Desktop\movietrailersource_movie_trailer_merged_info.json', 'r', encoding='utf8') as trailer:
