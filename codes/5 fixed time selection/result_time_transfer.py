# This program calculate the difference of movie release time and the trailer release time for each trailer.
# Please export the data all_new_movie_trailer_merged_info into json first. 
# This file would store the data to data table in mysql automatically, please create the table first.
import json
import re
from result_datamanage import DataManager
...
def load_comments():
    with open(r'C:\Users\student\Desktop\thriller_textblob.json', 'r', encoding='utf8') as movie:
