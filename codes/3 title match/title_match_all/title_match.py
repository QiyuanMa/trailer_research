...
import json
import re
from title_match_all.datamanage import DataManager
...
def load_movie():
    with open(r'C:\Users\student\Desktop\all_imdb_merged_movielist_info.json', 'r', encoding='utf8') as movie:
