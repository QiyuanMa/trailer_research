import json
import re
from title_match_749.datamanage_rapidtrailer import DataManager

db = DataManager()


def load_trailer():
    with open(r'C:\Users\student\Desktop\rapidtrailer_movie_trailer_info.json', 'r', encoding='utf8') as trailer:
